...
namespace InventorySystem.Pages.Siam
{
    public class EditSiamModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try
            {
                String connectionString = "Server=tcp:pakaowbu.database.windows.net,1433;Initial Catalog=InventoryPakaow;Persist Security Info=False;User ID=pakaowbu;Password=!Bu123456;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
